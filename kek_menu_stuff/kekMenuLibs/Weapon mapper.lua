-- Lib Weapon mapper version: 1.0.2
...
function weapon_mapper.get_all_attachment_info_for_weapon(weapon_hash)
...
function weapon_mapper.get_weapon_attachment_details(weapon_hash)
	if weapon_attachments[weapon_hash] then
		return weapon_attachments[weapon_hash]
	else
		return {}
...
function weapon_mapper.get_maxed_attachments_for_weapon(weapon_hash)
	if weapon_attachments[weapon_hash] then
		local attachments = {}
...
function weapon_mapper.get_random_attachments_for_weapon(weapon_hash)
	if weapon_attachments[weapon_hash] then
		local attachments = {}
...
function weapon_mapper.set_ped_weapon_attachments(Ped, random_attachments, weapon_hash)
